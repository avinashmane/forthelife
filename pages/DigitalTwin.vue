...
import { useIndiathonStore } from "../stores/indiathon.js"
...
const indiathon = useIndiathonStore()
onMounted(async () => {
...
const activities = computed(() => indiathon.get('/activities/avinashmane@gmail,com/Y2024/M11'))
